...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		logRoute.GET("/conversation/:log_id", middleware.AdminAuth(), controller.GetConversationByLogId)
		logRoute.DELETE("/conversation/", middleware.AdminAuth(), controller.DeleteConversationRecords)
