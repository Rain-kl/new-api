...
// ============================================================================
// Personal: conversation content for consume logs (admin only)
// ============================================================================
...
export async function getConversationByLogId(
  logId: number
): Promise<{
  success: boolean
  message?: string
...
export async function deleteConversationRecords(
  targetTimestamp: number
): Promise<{ success: boolean; message?: string; data?: number }> {
  const res = await api.delete(
    `/api/log/conversation/?target_timestamp=${targetTimestamp}`
  )
  return res.data
}
