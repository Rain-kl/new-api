...
*/
import { ProxiesChannelsDialog } from './channels-dialog'
import { ProxiesDeleteDialog } from './proxies-delete-dialog'
import { ProxiesImportExportDialog } from './import-export-dialog'
...
export function ProxiesDialogs() {
  ...
  return (
    <>
      ...
      <ProxiesDeleteDialog />
      <QualityReportDialog />
      <ProxiesChannelsDialog />
      <ProxiesImportExportDialog />
    </>
  )
}
