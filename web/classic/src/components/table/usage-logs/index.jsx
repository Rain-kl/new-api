...
const LogsPage = () => {
  ...
  return (
    <>
      ...
      <ConversationModal
        visible={logsData.showConversationModal}
        loading={logsData.conversationLoading}
        content={logsData.conversationContent}
        onClose={() => logsData.setShowConversationModal(false)}
        t={logsData.t}
      />
