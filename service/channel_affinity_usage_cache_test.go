...
func uniqueChannelAffinityUsageCacheTestKey(t *testing.T) string {
	t.Helper()
	return fmt.Sprintf("%s_%d", t.Name(), channelAffinityUsageCacheTestSequence.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityUsageCacheTestKey(t)
	usingGroup := "default"
	keyFP := "fp_" + ruleName
